...
Route::get('consultarComics', [controllerViews::class, 'consultComic'])->name('consComic');
...
Route::get('consultarArticulo', [controllerViews::class, 'consultArtic'])->name('consArtic');
...
Route::get('consultarUsuario', [controllerViews::class, 'consultUsu'])->name('consUsu');
...
Route::get('consultarProveedor', [controllerViews::class, 'consultProve'])->name('consProve');
